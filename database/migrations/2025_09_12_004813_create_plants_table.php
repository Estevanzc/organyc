...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('plants', function (Blueprint $table) {
            ...
            $table->enum("type", ["Tree","Shrub","Herb","Vine","Grass","Fern","Moss","Algae","Succulent","Aquatic","Other"]); // Filter
            $table->enum("growth_form", ["Annual","Biennial","Perennial","Ephemeral","Evergreen","Deciduous","Semi-evergreen","Other"]);
            $table->enum("leaf_type", ["None","Simple","Compound","Pinnate","Bipinnate","Palmate","Trifoliate","Needle-like","Scale-like","Lobed","Other"]); // Filter
